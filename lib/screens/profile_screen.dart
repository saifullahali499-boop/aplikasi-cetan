...
class _ProfileScreenState extends State<ProfileScreen> {
  // State lokal untuk tombol saklar notifikasi
  ...
  // 3. Fitur Baru: Fungsi Pengaturan Privasi (Simpan ke Firestore)
  ...
  // 4. Fitur Baru: Jendela Pesan Berbintang
      ...
      body: SafeArea(
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            String livePrivacy = 'Semua Orang'; // Default setelan privasi
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // Menu Notifikasi (Switch)
                          SwitchListTile(
                            secondary: const Icon(Icons.notifications_none, color: Colors.black54),
                            title: const Text('Notifikasi', style: TextStyle(color: darkTextColor)),
                            ...
                            onChanged: (bool value) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(value ? 'Notifikasi diaktifkan' : 'Notifikasi disenyapkan'),
                          ...
                          // Fitur Baru: Menu Berbintang Berfungsi
                          ListTile(
                          ...
                          // Fitur Baru: Menu Privasi Berfungsi
                          ListTile(
